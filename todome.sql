...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2025 at 06:38 AM
...
(1, 'ars', '$2y$10$BTHu/eBmYMKt9O1uu//OV.QS0AX7FjBuiOCp/Wo/95W31iYBMHxrS', 'ars@gmail.com', '2025-02-12 03:31:05');
...
ALTER TABLE `tasks`
  ...
  ADD CONSTRAINT `tasks_ibfk_3` FOREIGN KEY (`list_id`) REFERENCES `lists` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
